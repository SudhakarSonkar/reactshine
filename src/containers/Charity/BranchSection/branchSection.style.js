...
import pattern1 from 'common/assets/image/charity/branch/highlight-pattern.svg';
import pattern2 from 'common/assets/image/charity/branch/highlight-pattern2.svg';
  ...
  .rq_tab {
    ...
    .tab_menu {
      ...
      li {
        ...
        &:hover {
          color: ${themeGet('colors.primary', '#ABC9FF')};
          p {
            color: ${themeGet('colors.primary', '#ABC9FF')};
          }
        }
