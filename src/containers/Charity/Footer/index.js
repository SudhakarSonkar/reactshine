      ...
      <Container width="1260px">
        <Box className="row" {...row}>
          <Box className="col-one" {...colOne}>
            <Logo
              ...
              title="Agency"
            />
            <Text className="text" content="+91 84002 55888" />
            <Text className="text" content="+91 96169 72614" />
            <Link href="#1">
              <a className="mail">shinengoindia@gmail.com</a>
            </Link>
            <SelectWrapper>
        ...
        <Box className="row copyright" {...row}>
          <CopyrightText>
            <Text
              className="text"
              content="Made by Team Shine NGO"
            />
          </CopyrightText>
          <SocialList>
