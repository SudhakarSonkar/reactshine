      ...
      <ContentWrapper>
        <TextArea>
          <HighlightedText className="highlighted_text">
            <strong>NEWS</strong> 125 Child Adopted. 35 remains
            <Icon icon={chevronRight} />
          </HighlightedText>
          <Heading
            content="Welcome to Shine NGO"
          />
          <Heading
            as="h4"
          ...
          />
          <Text
            content="In a world where you can be anything, Be kind. We aspire to be Givers. Givers of love, Givers of good vibes and Givers of strength."
          />
          <Link href="#1">
            ...
            <Fragment>
              {bannerSlides.map((slide) => (
                <GlideSlide key={slide.id}>
                  <NextImage src={slide.thumb_url} alt="Charity Landing" />
                </GlideSlide>
              ))}
            </Fragment>
          </GlideCarousel>
